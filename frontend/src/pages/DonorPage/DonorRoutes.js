export const DonorRoutes = [
    ...
    { to: '/donor/booking_history', content: 'Lịch sử đặt hẹn' },
    { to: '/donor/events', content: 'Sự kiện hiến máu' },
    { to: '/donor/reward', content: 'Bảng xếp hạng' },
    { to: '/donor/account', content: 'Tài khoản' },
];
