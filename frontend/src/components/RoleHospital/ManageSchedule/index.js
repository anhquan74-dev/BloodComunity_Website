    ...
    <div className="container">
      <div className="row">
        <div className="col-12">
          ...
          <DatePicker dateFormat='dd/MM/yyyy' selected={startDate} onChange={handleChangeDatePicker} minDate={new Date()} />
        </div>
        <div className="col-12">
        ...
        <button className="btn btn-save col-1" onClick={handleCreateSchedule}>Lưu thông tin</button>
